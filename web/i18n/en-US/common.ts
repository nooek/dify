const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Koality account',
    langGeniusAccountTip: 'Your Koality account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Koality to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Koality allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Koality\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Koality {{version}} is now available.',
    latestAvailable: 'Koality {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
