const translation = {
  ...
  welcome: '👋 Welcome to Koality, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Koality Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Koality',
  invalid: 'The link has expired',
  explore: 'Explore Koality',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Koality and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Koality Enterprise license for your workspace has expired. Please contact your administrator to continue using Koality.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Koality license server. Please contact your administrator to continue using Koality.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Koality Enterprise license for your workspace is inactive. Please contact your administrator to continue using Koality.',
}
